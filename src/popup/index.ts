...
function renderTexts() {
  (document.getElementById('titleLabel') as HTMLElement).textContent = t('savedVideos');
  (document.getElementById('logLabel') as HTMLElement).textContent = t('logToggle');
  (document.getElementById('deleteAll') as HTMLButtonElement).textContent = t('deleteAll');
  (document.getElementById('openList') as HTMLButtonElement).textContent = t('openList');
  (document.getElementById('langLabel') as HTMLElement).textContent = t('langLabel');
  (document.getElementById('settingsText') as HTMLElement).textContent = t('settings');
}
