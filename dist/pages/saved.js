...
function renderTexts() {
    document.getElementById('titleLabel').textContent = t('savedVideos', currentLang);
    document.getElementById('deleteAll').textContent = t('deleteAll', currentLang);
    document.getElementById('langLabel').textContent = t('langLabel', currentLang);
    document.getElementById('settingsText').textContent = t('settings', currentLang);
}
