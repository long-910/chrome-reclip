...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateTime = () => {
        const timeElement = appElement.querySelector('h1') ?? appElement.appendChild(document.createElement('h1'));
        if (timeElement) {
    ...
    const aElement = appElement.querySelector('a') ?? appElement.appendChild(document.createElement('a'));
    aElement.href = link;
